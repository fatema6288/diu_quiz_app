                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <form action="{{route('updateCategory', $category->id)}}" method="post" >
                            ...
                            <label class="block">
                                ...
                                @enderror
                                <input name="cat_name" value="{{old('name', $category->cat_name)}}" type="text" class="mt-1 block w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0" />
                            </label>                            
